...
import com.uco.yourplus.serviceyourplus.usecase.microservices.procesador.producer.producto.RabbitMQUpdateProducerProducto;
...
public class RabbitMQUpdateProducerProductoImpl implements RabbitMQUpdateProducerProducto {
    ...
    public RabbitMQUpdateProducerProductoImpl(@Qualifier("propertiesCatalogProductoProducer") PropertiesCatalogProductoProducer producer, RabbitTemplate rabbitTemplate, ConfigRabbitContentProduct configRabbitProductContent) {
