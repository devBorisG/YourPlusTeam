package com.uco.yourplus.serviceyourplus.usecase.microservices.procesador.producer.configuration.categoria.implementation;
...
@Component
public class ConfigRabbitContentCategoriaImpl implements ConfigRabbitContentCategoria {

    private final MapperJsonObject mapperJsonObject;


    public ConfigRabbitContentCategoriaImpl(MapperJsonObject mapperJsonObject) {
