...
@Service
@Transactional
public class SendDeleteLaboratoryMessageFacadeImpl implements SendDeleteLaboratoryMessageFacade {


    private final SendDeleteLaboratoryMessage useCase;

    public SendDeleteLaboratoryMessageFacadeImpl(SendDeleteLaboratoryMessage useCase) {
