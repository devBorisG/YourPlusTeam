...
public class HandlerReceiveMessageSaveProductoImpl implements HandlerReceiveMessageSaveProducto {
    ...
    public HandlerReceiveMessageSaveProductoImpl(RabbitTemplate rabbitTemplate, ProcessRabbitResponse<ProductoDomain> convertObject, @Qualifier("propertiesCatalogProductoReceiver") PropertiesCatalogProductoReceiver productoReceiver) {
