...
@Service
@Transactional
public class SendSaveMessageFacadeImpl implements SendSaveLaboratoryMessageFacade {

    private final SendSaveLaboratoryMessage useCaseLaboratory;

    public SendSaveMessageFacadeImpl(SendSaveLaboratoryMessage useCaseLaboratory) {
