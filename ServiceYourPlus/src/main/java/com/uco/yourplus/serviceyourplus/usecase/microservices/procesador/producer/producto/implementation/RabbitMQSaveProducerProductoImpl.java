...
public class RabbitMQSaveProducerProductoImpl implements RabbitMQSaveProducerProducto {
    ...
    public RabbitMQSaveProducerProductoImpl(@Qualifier("propertiesCatalogProductoProducer") PropertiesCatalogProductoProducer producer, RabbitTemplate rabbitTemplate, ConfigRabbitContentProduct configRabbitProductContent) {
